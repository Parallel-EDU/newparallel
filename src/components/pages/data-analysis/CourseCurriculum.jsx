...
const modules = [
  {
    ...
    description:
      "Data Analysis Fundamentals – Data types, statistics, Excel for analytics",
  }, // [attached_file:1]
  {
    id: 2,
    title: "Module 2: Python for Data Analysis",
    description:
      "NumPy, Pandas for manipulation, Matplotlib & Seaborn for visualization",
  }, // [attached_file:1]
  {
    id: 3,
    title: "Module 3: SQL & Database Handling",
    description: "Queries, joins, aggregation for analysis",
  }, // [attached_file:1]
  {
    id: 4,
    title: "Module 4: Data Cleaning & Preparation",
    description: "Handling missing data, normalization, and preprocessing",
  }, // [attached_file:1]
  {
    id: 5,
    title: "Module 5: Data Visualization & Storytelling",
    description: "Dashboards and insights using Tableau / Power BI",
  }, // [attached_file:1]
  {
    id: 6,
    title: "Module 6: Mini Projects & AI Integration",
    description:
      "Analyze datasets with predictive modeling, basic AI applications",
  }, // [attached_file:1]
  {
    id: 7,
    title: "Module 7: Internship Project",
    description: "Work on a live analytics project under mentor supervision",
  }, // [attached_file:1]
  {
    id: 8,
