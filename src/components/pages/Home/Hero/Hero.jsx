        ...
        <main className="px-20 z-50 relative max-md:px-10 max-xl:p-10 max-sm:px-5 max-md:pt-[50px] max-sm:pb-0 max-sm:pt-[30px] flex justify-between max-hamburger:items-center max-smalllaptop:gap-5 max-hamburger:flex-col pb-[29.5px] pt-[76.5px]">
          <div className="max-hamburger:w-full widescreen:w-[60%] max-xl:w-[73%]">
            <div className="relative z-30 w-full">
              ...
              <p className="text-[16px]  mb10 mt-5  font-normal widescreen:text-[20px] widestscreen:text-[24px] widescreen:leading-[150%] mb[12px] w-[80%] leading-6 text-[#C7C7C7]">
          ...
          <div className="w-[457px] widescreen:h-[calc(100%-110px)] widescreen:w-[35%] relative max-sm:w-full z-30 backdrop-blur-sm max-hamburger:w-[70%] flex flex-col z-20 gap-[32px] max-sm:gap-[20px] max-sm:h-auto h-589px] px-[16px] max-sm:px-[20px] max-sm:py-[16px] py-[16px] rounded-[14px] bg-[#000]">
