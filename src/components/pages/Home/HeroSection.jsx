    ...
    >
      ...
      <div className="relative z-[99999] max-w-[1080px] mx-auto">
        ...
        <Link href="/signup" className="z-[99999]">
          <button className="mt-10 border border-[#1BD44F] text-[#1BD44F] hover:bg-[#30E29D] hover:text-[#292929] px-8 py-[11px] rounded-md text-lg font-medium hover:bg-[#1BD44F]/10 transition-all duration-300">
            Enroll Now
          </button>
        </Link>
      </div>
