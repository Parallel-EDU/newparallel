    ...
    <>
      <div className="pt-[102.57px] d-sec max-xl:p-10 max-md:p-4 relative max-sm:py-[32px] max-sm:px-[16`px] max-md:px-[40px] relative pb-[50.43px] pl-[80px] pr-[79px]">
        ...
        <Link href={"/courses"} className="flex items-center justify-center">
          <button className="w-[244px] max-md:block font-['Graphikmid']  mt-[67px] h-[53px] bg-[#000] rounded-[8px] border border-[#30E29D] font-[500] text-[#30E29D] hover:bg-[#30E29D] hover:text-[#292929] text-[16px] widescreen:text-[20px] widestscreen:text-[24px] widescreen:leading-[150%] txtt-[16px]">
