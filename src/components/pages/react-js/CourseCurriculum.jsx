...
const modules = [
  {
    ...
    description: "Components, JSX, Props, State, Lifecycle Methods",
  }, // [attached_file:1]
  {
    id: 2,
    title: "Module 2: Advanced React",
    description:
      "Hooks (useState, useEffect, useContext), Context API, Higher-Order Components",
  }, // [attached_file:1]
  {
    id: 3,
    title: "Module 3: State Management",
    description: "Redux, Redux Toolkit, Async Actions with Thunk/Saga",
  }, // [attached_file:1]
  {
    id: 4,
    title: "Module 4: Routing & API Integration",
    description: "React Router, REST API calls, Axios integration",
  }, // [attached_file:1]
  {
    id: 5,
    title: "Module 5: Testing & Optimization",
    description:
      "Unit testing with Jest, End-to-End testing with Cypress, Performance tuning",
  }, // [attached_file:1]
  {
    id: 6,
    title: "Module 6: Mini Projects & AI Integration",
    description:
      "Use GenAI coding tools to optimize components and automate repetitive UI tasks",
  }, // [attached_file:1]
  {
    id: 7,
