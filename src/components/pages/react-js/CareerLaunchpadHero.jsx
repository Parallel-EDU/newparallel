...
export default function CareerLaunchpadHero() {
  const features = [
    {
      title: "Hands-On React Projects",
      desc: "Build server-side rendered and static web applications for your portfolio",
    },
    {
    ...
    },
    {
      ...
      desc: "Build dynamic, interactive web apps and single-page applications for your portfolio",
    },
  ];
