...
const modules = [
  {
    ...
    description: "CRM basics, navigation, and platform overview",
  }, // [attached_file:1]
  {
    id: 2,
    title: "Module 2: Salesforce Administration",
    description: "User management, security, objects, and workflows",
  }, // [attached_file:1]
  {
    id: 3,
    title: "Module 3: Lightning Web Components & Development",
    description: "Build dynamic components and apps",
  }, // [attached_file:1]
  {
    id: 4,
    title: "Module 4: Automation & Reporting",
    description: "Process Builder, Flow, dashboards, and analytics",
  }, // [attached_file:1]
  {
    id: 5,
    title: "Module 5: App & Integration Projects",
    description: "Connect Salesforce with external systems via APIs",
  }, // [attached_file:1]
  {
    id: 6,
    title: "Module 6: Internship Project",
    description: "Implement a live CRM project under mentor supervision",
  }, // [attached_file:1]
  {
    id: 7,
          ...
          <div className="relative bg-[#FFFFFF14] rounded-[32px] p-10">
            ...
            {modules.map((module) => (
              ...
              >
                ...
                <div className="absolute left-20 max-md:hidden md:left-[11rem] h-[80%] z-[1] top-[5rem] bottom-0 w-[0.99px] border-l-[0.99px] border-dashed border-gray-600"></div>
