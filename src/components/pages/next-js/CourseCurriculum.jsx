...
const modules = [
  {
    ...
    description: "Pages, Components, Routing, Data Fetching",
  }, // [attached_file:1]
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Module 3: API Routes & Backend Integration",
    description: "Connecting with Node.js / Express APIs",
  }, // [attached_file:1]
  {
    id: 4,
    title: "Module 4: State Management & UI Testing",
    description: "Redux, React Context, Jest, Cypress",
  }, // [attached_file:1]
  {
    id: 5,
    title: "Module 5: Mini Projects & AI Tools",
    description: "Enhance productivity with GenAI coding assistants",
  }, // [attached_file:1]
  {
    id: 6,
    title: "Module 6: Internship Project",
    description: "Work on a live Next.js application under mentor guidance",
  }, // [attached_file:1]
  {
    id: 7,
    title: "Module 7: Career & Placement Prep",
    description: "Resume, mock interviews, portfolio showcase, job assistance",
  }, // [attached_file:1]
];
