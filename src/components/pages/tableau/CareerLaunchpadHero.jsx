...
export default function CareerLaunchpadHero() {
  ...
  const features = [
    {
      title: "Hands-On Tableau Projects",
      desc: "Create interactive dashboards and reports for real-world datasets",
    },
    {
      title: "Internship Opportunities",
      desc: "Work on live analytics and reporting projects under mentor supervision",
    },
    {
    ...
    },
    {
      ...
      desc: "Learn Tableau Desktop, Tableau Prep, calculated fields, data blending, and storytelling",
    },
  ];
