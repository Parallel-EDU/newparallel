...
const HeroBoot = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Name === "") {
      ...
      try {
        const response = await axios.post("/api/certifications/devOps", data);
          ...
          <div className="max-hamburger:w-full widescreen:w-[60%] max-xl:w-[73%]  w-[65%]">
            <div className="relative z-30 w-full">
              ...
              <p className="text-[16px] font-['Graphikthin']  mb-10 mt-4  font-[400] widescreen:text-[20px] widestscreen:text-[24px] widescreen:leading-[150%] mb[12px] w-[70%] leading-[24px] text-[#C7C7C7]">
                Learn CI/CD, automation, cloud tools, and containerization. Gain
                hands-on experience, build real-world DevOps projects, get 100%
