...
export default function CareerLaunchpadHero() {
  const features = [
    {
      title: "Hands-On DevOps Projects",
      desc: "Automate deployments, monitor systems, and manage infrastructure efficiently",
    },
    {
    ...
    },
    {
      ...
      desc: "Learn Git, Linux, Shell scripting, Jenkins, Docker, Kubernetes, AWS, Terraform, and monitoring tools",
    },
  ];
