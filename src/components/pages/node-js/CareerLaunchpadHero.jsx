...
export default function CareerLaunchpadHero() {
  ...
  const features = [
    {
      title: "Hands-On Node.js Projects",
      desc: "Build scalable backend applications and RESTful APIs for your portfolio",
    },
    {
    ...
    },
    {
      ...
      desc: "Learn Express.js, MongoDB, API design, authentication, and deployment best practices",
    },
  ];
