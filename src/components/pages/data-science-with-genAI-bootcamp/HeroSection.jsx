...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative flex flex-col page-break items-center justify-center text-center min-h-[650px] px-6 overflow-hidden"
      // style={{
      //   background: `
      //     linear-gradient(
      //       179.63deg,
    ...
    >
      ...
      <div className="relative z-[99999] max-w-[1080px] mx-auto">
        <h1 className="text-[64px] leading-tight font-['Graphikthin'] text-white max-md:text-[48px] max-sm:text-[36px]">
          Start your Data Science career with parallel today.
        </h1>

        <p className="mt-6 text-white/80 text-lg max-sm:text-base">
          Learn, build, and get hired with India’s most practical and affordable
          AI-powered Bootcamp.
        </p>
