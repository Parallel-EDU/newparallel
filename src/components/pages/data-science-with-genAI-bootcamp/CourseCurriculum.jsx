...
//       {/* Main Content */}
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 pb-16">
...
//         <button
//           onClick={openModal}
//           className="group font-['Graphikmid'] rounded-[8px] hover:bg-[#30E29D] hover:text-[#292929] border border-[#30E29D] px-7 py-[14px] text-[15px] text-[#30E29D] transition-colors hover:bg-[#22e19d10] hoveext-white"
//         >
...
export default function CourseCurriculum() {
  ...
  return (
    <div>
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 pb-16">
        <div className="flex items-start gap-6 lg:gap-8 max-lg:flex-col">
          {/* Left Section */}
          <div className="lg:w-[30%] w-full sticky top-10 self-start max-lg:relative">
            <div className="space-y-3">
              {coursePhasesData.map((coursePhase) => (
                <div
                  key={coursePhase.id}
          ...
          <div className="lg:w-[70%] w-full space-y-6">
            {coursePhasesData.map((coursePhase) => (
              ...
              >
                {/* Phase Header */}
                <div className="flex justify-between items-start mb-6 max-lg:flex-col max-lg:gap-2">
                  <div>
                    <h2 className="text-2xl sm:text-[24px] text-[#E0E0E0] font-['Graphikthin'] font-normal mb-2">
                      {coursePhase.phase} : {coursePhase.title}
                    </h2>
