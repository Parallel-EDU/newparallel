...
const roadmapSteps = [
  {
    ...
    description: "Build the foundation to solve real-world coding challenges.",
    side: "left",
    items: [
      "Master data structures: arrays, linked lists, stacks, queues, trees, graphs, hash tables",
      "Learn algorithms: sorting, searching, recursion, dynamic programming",
      "Explore advanced concepts: graph theory, optimization techniques",
      "Complete hands-on assignments to strengthen problem-solving skills",
    ],
  },
  {
    id: 2,
    ...
    title: "Backend Development (Choose Your Track: Node.js / Spring Boot)",
    description: "Build robust server-side applications and APIs.",
    side: "right",
    items: [
      "Learn your chosen backend framework (Node.js / Spring Boot)",
      "Connect and manage databases: MongoDB, MySQL, PostgreSQL",
      "Build RESTful APIs with authentication & security",
      "Complete a backend project showcasing real-world skills",
    ],
  },
  {
    id: 3,
    ...
    description: "Master scalable system design and architectural patterns.",
    side: "left",
    items: [
      "Learn scalability principles and distributed systems",
      "Understand microservices and API gateway patterns",
      "Design high-level system architectures",
      "Master caching, load balancing, and database optimization",
    ],
  },
  {
    id: 4,
    ...
    description:
      "Integrate all learnings into a complete production-ready application.",
    side: "right",
    items: [
  ...
  },
  {
    ...
    side: "left",
    items: [
      "Practice coding interview problems and techniques",
      "Master system design interview questions",
  ...
  return (
    ...
    >
      <h2 className="leading-tight lg:text-[64px] font-['Graphikthin'] font-light tracking-tight mb-16 text-pretty">
        Your next 6-9 months fast-track roadmap to your dream job
      </h2>
                  ...
                  <div className="space-y-3">
                    {step.items.map((item, itemIdx) => (
                      <div key={itemIdx} className="flex gap-3">
                        ...
                        <span className="text-gray-300 font-['Graphikthin'] font-light text-[16px]  text-sm sm:text-base">
                          {item}
                        </span>
                      </div>
                    ))}
