...
export default function CareerLaunchpadHero() {
  const features = [
    {
      title: "Hands-On AI Agent Projects",
      desc: "Hands-On Prompt Projects Learn practical prompting for ChatGPT, Claude, Gemini, and APIs",
    },
    {
    ...
    },
    {
      ...
      desc: "Train on OpenAI, Anthropic, Gemini, Hugging Face, and LangChain",
    },
  ];
