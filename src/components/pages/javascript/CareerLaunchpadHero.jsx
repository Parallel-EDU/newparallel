...
export default function CareerLaunchpadHero() {
  const features = [
    {
      title: "Hands-On JavaScript Projects",
      desc: "Build interactive web applications and dynamic user interfaces to showcase in your portfolio",
    },
    {
    ...
    },
    {
      ...
      desc: "Learn JavaScript ES6+, DOM manipulation, asynchronous programming, APIs, and modern JS frameworks",
    },
  ];
